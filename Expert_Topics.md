...
Understanding what Git actually stores turns most of its odd behaviour into common sense.
...
- `.gitattributes` beyond ignoring: end-of-line normalisation, custom diff drivers for binary
